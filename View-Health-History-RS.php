...
<?php 
    ...
    if(empty($animalid) || empty($animalname)){
        ...
        $query="SELECT * FROM medicalhistory WHERE animalID=? AND type='routine service' ORDER BY date DESC;";
                ...
                <div class="containter-fluid d-flex justify-content-center align-items-center">
                    <div class="container pt-4">
                        <div class="container text-start px-1">
                            ...
                            <div class="container-fluid text-center mb-2">
                                <a href="Add-Health-History-RS-Form.php?animalid=<?php echo $animalid; ?>&animalname=<?php echo $animalname; ?>"><button class="btn btn-success"><i class="fa-solid fa-plus"></i> Add</button></a>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="largecell d-flex justify-content-center align-items-center" >
                                                <a href="Update-Health-History-RS-Form.php?mhid=<?php echo $data['mhID']; ?>&animalid=<?php echo $data['animalID']; ?>&animalname=<?php echo $animalname; ?>"><button class="btn btn-primary mx-1"><i class="fa-solid fa-pen-to-square"></i> Update</button></a>
                                                <a href="functions/delete-mh-RS.php?mhid=<?php echo $data['mhID']; ?>&animalid=<?php echo $data['animalID']; ?>&animalname=<?php echo $animalname; ?>"><button class="btn btn-danger mx-1"><i class="fa-solid fa-trash"></i></button></a>
                                            </td>
                                            <?php 
                                            endforeach;
