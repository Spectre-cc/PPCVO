                ...
                <hr class="horizontal-rule p-0 my-3">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="text-center dropdown-menu">
                            <li><a class="dropdown-item" href="View-Users-Personnel.php"><i class="fa-solid fa-person"></i> Personnel</a></li>
                            <li><a class="dropdown-item" href="View-Users-Admin.php"><i class="fa-solid fa-user-tie"></i> Admin</a></li>
                        </ul>
                    </div>
                    <hr class="horizontal-rule p-0 my-3">
