    ...
    <div class="container-fluid m-0 p-0">
        <div class="wrapper d-flex m-2">
            ...
            <div class="content container bg-light rounded-4 min-vh-100 px-0" style="max-width: 80vw;">
                ...
                <form method="POST" action="functions/update-mh-RS.php" class="container-fluid my-3 p-4 w-50 rounded bg-transparent shadow-lg h-auto">
                        ...
                        <div class="form-group pt-3 container-fluid text-center">
                            <input class="btn btn-success w-50" type="submit" id="update-mh-RS" name="update-mh-RS" value="Accept">
                        </div>
                    </form>
                </div>
            </div>
