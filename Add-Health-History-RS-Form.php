        ...
        <div class="wrapper d-flex m-2">
            ...
            <div class="content container bg-light rounded-4 min-vh-100 px-0" style="max-width: 80vw;">
                <div class="containter-fluid justify-content-center align-items-center">
                    <form method="POST" action="functions/add-mh-RS.php" class="container-fluid my-3 p-4 w-50 rounded bg-transparent shadow-lg h-auto">
                        ...
                        <div class="form-group pt-3 container-fluid text-center">
                            <input class="btn btn-success w-50" type="submit" id="add-mh-RS" name="add-mh-RS" value="Accept">
                        </div>
                    </form>
                </div>
            </div>
