<?php 
    ...
    if(isset($_POST['password-reset'])){
        ...
        $query="SELECT email FROM user WHERE email=? AND type='admin'";
        ...
        if(empty($newpassword)){
            ...
            header('Location: Create-New-Password-Admin.php?selector='.$selector.'&validator'.$validator.'&alertmessage='.$alertmessage);
            exit();
        }
